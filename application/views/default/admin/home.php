...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url();?>templates/default/admin/plugins/images/logo-pos.png">
...
<body class="fix-header">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo site_url();?>home/angkatan" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Angkatan</a>
                    </li>            
                    <li>
                        <a href="<?php echo site_url();?>home/jurusan" class="waves-effect"><i class="fa fa-briefcase fa-fw" aria-hidden="true"></i>Jurusan</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url();?>home/prodi" class="waves-effect"><i class="fa fa-bars fa-fw" aria-hidden="true"></i>Data Prodi</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url();?>home/mahasiswa" class="waves-effect"><i class="fa fa-users fa-fw" aria-hidden="true"></i>Mahasiswa</a>
                    </li>        
                  <!--   <li>
                        <a href="<?php echo site_url();?>home/semester" class="waves-effect"><i class="fa fa-columns fa-fw" aria-hidden="true"></i>Semester</a>
                    </li> -->
                    <?php } ?>
                    <?php if ($this->session->userdata('logged_in') == TRUE && $this->session->userdata('admin_level') == '2') { ?> 
                    <li>
                        <a href="<?php echo site_url();?>home/mahasiswa" class="waves-effect"><i class="fa fa-users fa-fw" aria-hidden="true"></i>Mahasiswa</a>
                    </li>     
                    <li>
                        <a href="<?php echo site_url();?>home/angkatan" class="waves-effect"><i class="fa fa-folder fa-fw" aria-hidden="true"></i>Angkatan</a>
                    </li>     
                    <li>
                        <a href="<?php echo site_url();?>home/pembayaran" class="waves-effect"><i class="fa fa-dollar fa-fw" aria-hidden="true"></i>Pembayaran</a>
                    </li>     
                    <li>
                        <a href="<?php echo site_url();?>home/laporan" class="waves-effect"><i class="fa fa-print fa-fw" aria-hidden="true"></i>Laporan</a>
                    </li>                          
                    <li>
                        <a href="<?php echo site_url();?>home/rekapitulasi" class="waves-effect"><i class="fa fa-file-o fa-fw" aria-hidden="true"></i>Rekapitulasi</a>
                    </li>     
                    <?php } ?>   
                    <?php if ($this->session->userdata('logged_in') == TRUE && $this->session->userdata('admin_level') == '3') { ?>                   
                    <li>
                        <a href="<?php echo site_url();?>home/rekapitulasi" class="waves-effect"><i class="fa fa-file-o fa-fw" aria-hidden="true"></i>Rekapitulasi</a>
                    </li> 
                    <?php } ?>     
                    <!--li>
                        <a href="<?php echo site_url();?>home/krs" class="waves-effect"><i class="fa fa-file fa-fw" aria-hidden="true"></i>KRS</a>
                    </li-->
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="<?php echo base_url();?>templates/default/admin/plugins/bower_components/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo base_url();?>templates/default/admin/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- Menu Plugin JavaScript -->
    <script src="<?php echo base_url();?>templates/default/admin/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js"></script>
    <!--slimscroll JavaScript -->
    <script src="<?php echo base_url();?>templates/default/admin/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="<?php echo base_url();?>templates/default/admin/js/waves.js"></script>
    <!--Counter js -->
    <script src="<?php echo base_url();?>templates/default/admin/plugins/bower_components/waypoints/lib/jquery.waypoints.js"></script>
    <script src="<?php echo base_url();?>templates/default/admin/plugins/bower_components/counterup/jquery.counterup.min.js"></script>
    <!-- chartist chart -->
    <script src="<?php echo base_url();?>templates/default/admin/plugins/bower_components/chartist-js/dist/chartist.min.js"></script>
    <script src="<?php echo base_url();?>templates/default/admin/plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js"></script>
    <!-- Sparkline chart JavaScript -->
    <script src="<?php echo base_url();?>templates/default/admin/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js"></script>
    ...
    <script src="<?php echo base_url();?>templates/default/admin/plugins/bower_components/toast-master/js/jquery.toast.js"></script>
