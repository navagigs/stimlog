            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="<?php echo site_url();?>website/" class="waves-effect"><i class="fa fa-home fa-fw" aria-hidden="true"></i>Beranda</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url();?>website/pembayaran" class="waves-effect"><i class="fa fa-check fa-fw" aria-hidden="true"></i>Data Pembayaran</a>
                    </li>           

                </ul>
                <div class="center p-20">
                     <a href="<?php echo site_url();?>mahasiswa/keluar" class="btn btn-danger btn-block waves-effect waves-light">Logout</a>
                 </div>
            </div>
